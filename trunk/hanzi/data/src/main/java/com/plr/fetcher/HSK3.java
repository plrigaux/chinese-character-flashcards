...
public class HSK3 extends CCDIC {
	...
	private void pushData() throws Exception {
		...
		int listIndex = 1;
		String idCode = null;
		try (PreparedStatement updateemp = CCDIC.conn.prepareStatement("insert into HSK_YBVOC ("
	...
	private void createTable() throws Exception {
		...
		try (InputStream u = this.getClass().getResourceAsStream("../database/HSK3.ddl");
