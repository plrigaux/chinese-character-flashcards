...
public class CwCellValidation extends ContentWidget {
  ...
  public static class CwConstants {
    String cwCellValidationColumnAddress() {
    	return "cwCellValidationColumnAddress";
    }
    ...
    String cwCellValidationDescription(){
    	return "cwCellValidationDescription";
    }

    String cwCellValidationError(){
    	return "cwCellValidationError";
    }

    String cwCellValidationName(){
    	return "cwCellValidationName";
    }
  }
   ...
   */
  public CwCellValidation() {
    super(new CwConstants().cwCellValidationName(),
    		new CwConstants().cwCellValidationDescription(), false, "ContactDatabase.java");
