...
final class Normalizer {
	...
	/**
	 * A conservative heuristic as to whether s is normalized according to
	 * Unicode Normal Form C. It is heuristic, because Caja needs to run with
	 * versions of the Java standard libraries that do not include
	 * normalization.
	 * 
	...
	public static boolean isNormalized(CharSequence s) {
		...
		for (int i = s.length(); --i >= 0;) {
			char ch = s.charAt(i);
			// Codepoints in [32, 126] U [160, 255] are identical in both
			// Unicode and
			// ISO 8859-1.
			// Codepoints in [0, 31] and [127, 159] are not part of ISO 8859-1.
			// They
			// are control characters in Unicode, and disallowed in identifiers
			// so
	...
	public static String normalize(CharSequence sb, Form string) {
		// TODO Auto-generated method stub
		return sb.toString();
	}

	static Map<String, String> accented = new HashMap<String, String>();
	...
	final static RegExp rep = RegExp.compile("\\u00E0","i");
